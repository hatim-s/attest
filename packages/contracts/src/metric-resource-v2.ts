...
import { httpRequestTemplateSchema } from './agent-resource-v2.js';
import { assertionCheckSchema } from './metric.js';
import {
...
import { METRIC_RESOURCE_SCHEMA_VERSION } from './versions.js';
...
/** Encodes one canonical v2 assertion, judge, executable, or HTTP metric resource. */
const metricResourceSchema = z
  .strictObject({
    schema: z.literal(METRIC_RESOURCE_SCHEMA_VERSION),
    id: resourceIdSchema,
    name: z.string().min(1),
