...
import { agentRequestSchema } from './agent.js';
import {
...
/**
 * Freezes the authored WebSocket transport surface consumed by the future CLI2.12 adapter.
...
const webSocketEvidenceBaseFields = {
  schema: z.literal(WEBSOCKET_EVIDENCE_SCHEMA_VERSION),
  request_id: webSocketRequestIdSchema,
  lifecycle: z.enum(['per_case', 'per_run']),
  connection_mode: webSocketConnectionModeSchema,
