...
const helpCommand = {
  ...
  aliases: [],
  alias_for: null,
  request_schema: 'attest.command-request#test.case.import',
...
describe('CLI protocol contracts', () => {
  ...
  it('requires every machine-help required field', () => {
    const help = { schema: CLI_HELP_SCHEMA_ID, command: helpCommand };
