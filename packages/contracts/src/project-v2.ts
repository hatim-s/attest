...
/** Encodes the generated v2 project index at attest.project.json. */
...
/**
 * Encodes the loader-facing project snapshot and aggregates every v2 reference invariant.
