...
const CLI_ERROR_DEFINITIONS = [
  ...
  {
    code: 'config_invalid',
    meaning: 'The selected configuration contains invalid user data.',
    likely_causes: ['Schema validation or a cross-reference check failed.'],
    retryable: false,
    exit_code: 1,
    repairs: ['Fix every reported configuration issue and rerun the command.'],
  },
  {
    code: 'config_not_found',
    meaning: 'No runnable configuration was found.',
    likely_causes: ['No explicit config path or discoverable v1 config exists.'],
    retryable: false,
    exit_code: 1,
    repairs: ['Pass `--config <path>` or run the command from a configured project.'],
  },
  {
    code: 'config_parse_failed',
    meaning: 'The configuration file is not valid JSON or YAML.',
    likely_causes: ['The file contains malformed syntax.'],
    retryable: false,
    exit_code: 1,
    repairs: ['Correct the file syntax and rerun the command.'],
  },
  {
    code: 'config_read_failed',
    meaning: 'The configuration file could not be read.',
    likely_causes: ['The file is missing or its permissions deny access.'],
    retryable: false,
    exit_code: 1,
    repairs: ['Check the path and file permissions, then rerun the command.'],
  },
  {
    code: 'init_conflict',
