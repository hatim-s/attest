...
const completedExecution = (
  ...
  execution: {
    ...
    attempts: [
      {
        status: 'ok',
        raw: { protocol: 'attest.agent/v1alpha1', output: resolvedCase.payload },
        diagnostics: {},
        durationMs: 5,
        warnings: [],
      },
    ...
    durationMs: 10,
    outcome: 'completed',
    response: { protocol: 'attest.agent/v1alpha1', output: resolvedCase.payload },
  },
  metrics,
});
