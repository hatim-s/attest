...
const CLI_AGENT_PATH = join(
  REPOSITORY_ROOT,
  'conformance/src/_tests/fixtures/fake-agents/cli-agent.cjs',
);
const HTTP_AGENT_PATH = join(
  REPOSITORY_ROOT,
  'conformance/src/_tests/fixtures/fake-agents/http-agent.cjs',
);
const MARKER_PROBE_AGENT_PATH = join(
  REPOSITORY_ROOT,
  'packages/core/src/runner/_tests/fixtures/marker-probe-agent.cjs',
);
